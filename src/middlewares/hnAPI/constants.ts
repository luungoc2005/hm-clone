...
export const API_MAX_ITEM: string = `${API_ROOT}maxitem.json`;
export const API_TOP_STORIES: string = `${API_ROOT}topstories.json`;
export const API_NEW_STORIES: string = `${API_ROOT}newstories.json`;
export const API_BEST_STORIES: string = `${API_ROOT}beststories.json`;